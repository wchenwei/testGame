...
@Slf4j
public class InnerClientHandler extends SimpleChannelInboundHandler<HMProtobuf.HMRequest> {
	private AbstractInnerClientHandler requestHandler;
	
	public InnerClientHandler(AbstractInnerClientHandler requestHandler) {
...
//		ctx.close();
	...
	public void handlerRemoved(ChannelHandlerContext ctx) throws Exception {
		...
		System.err.println(ctx.name() + ctx.channel().remoteAddress() + "正常退出");
