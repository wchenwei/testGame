...
public class SensitiveWordUtil{
	...
	public static void loadKeyWord(Set<String> keyWordSet){
     ...
     */
    public static synchronized void add(Set<String> sensitiveWordSet) {
    	sensitiveWordMap = new SensitiveWordInit().initKeyWord(sensitiveWordSet);
    	HypyShieldWorldUtils.loadShieldWorld(sensitiveWordSet);
    }
    
    
    public static synchronized void add(String sensitiveWord) {
           sensitiveWordMap.put(sensitiveWord, sensitiveWord);
    }
    
    public static synchronized void del(String[] words){
    	for(String word:words){
    		sensitiveWordMap.remove(word);
    	}
    }
    
    public static synchronized void del(String word){
    	sensitiveWordMap.remove(word);
    }
