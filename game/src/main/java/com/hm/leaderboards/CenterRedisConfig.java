...
@Data
@Component
@ConfigurationProperties(prefix = "centerredis")
public class CenterRedisConfig {
    private static CenterRedisConfig instance = null;

    public static CenterRedisConfig getInstance() {
        if (instance == null) {
            instance = SpringUtil.getBean(CenterRedisConfig.class);
        }
        return instance;
    }
