...
@FileConfig("active_771_gift")
public class Active771GiftTemplate {
	private Integer id;
	...
	public Integer getRecharge_group() {
		return recharge_group;
	}

	public void setRecharge_group(Integer recharge_group) {
		this.recharge_group = recharge_group;
	}
