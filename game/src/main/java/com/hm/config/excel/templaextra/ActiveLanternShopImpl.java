...
import com.hm.config.excel.temlate.ActiveLanternShopTemplate;
import com.hm.model.item.Items;
import com.hm.util.ItemUtils;

import java.util.List;
import java.util.stream.Collectors;
@FileConfig("active_lantern_shop")
public class ActiveLanternShopImpl extends ActiveLanternShopTemplate {
	//奖励
