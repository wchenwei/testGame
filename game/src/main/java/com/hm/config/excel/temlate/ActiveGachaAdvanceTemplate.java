...
public class ActiveGachaAdvanceTemplate {
	...
	private String adv_ten_getpaper;
	...
	public String getAdv_ten_getpaper() {
		return adv_ten_getpaper;
	}

	public void setAdv_ten_getpaper(String adv_ten_getpaper) {
		this.adv_ten_getpaper = adv_ten_getpaper;
	}
