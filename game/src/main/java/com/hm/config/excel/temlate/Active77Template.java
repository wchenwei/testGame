...
@FileConfig("active_77")
public class Active77Template {
	private Integer id;
	...
	public Integer getReward_once() {
		return reward_once;
	}

	public void setReward_once(Integer reward_once) {
