...
import com.hm.config.excel.temlate.Active101TreasureRateTemplate;
 ...
 * Date: 2019-08-09
 */
@FileConfig("active_101_treasure_rate")
public class Active101TreasureRateTemplateImpl extends Active101TreasureRateTemplate {
