...
import com.hm.config.excel.temlate.ActiveSpringTreasureRateTemplate;
...
@FileConfig("active_spring_treasure_rate")
public class ActiveSpringTreasureRateTemplateImpl extends ActiveSpringTreasureRateTemplate {
