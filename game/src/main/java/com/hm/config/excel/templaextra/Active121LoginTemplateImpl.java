...
import com.hm.config.excel.temlate.Active1001LoginTemplate;
...
@FileConfig("active_1001_login")
public class Active121LoginTemplateImpl extends Active1001LoginTemplate {
	//奖励
