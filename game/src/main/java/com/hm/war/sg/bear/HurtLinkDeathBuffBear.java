...
import com.hm.war.sg.buff.HurtLinkBuffDeath;
...
public class HurtLinkDeathBuffBear extends BuffBear{
	private List<Integer> linkIds = Lists.newArrayList();

	public HurtLinkDeathBuffBear(int atkId, long continueFrame, long effectFrame,
	...
	public BaseBuffer createBuffer() {
		...
		return new HurtLinkBuffDeath(endFrame, value, linkIds);
	}
}
