...
import com.hm.war.sg.bear.HurtLinkDeathBuffBear;
 ...
 * @version V1.0
 */
public class HurtLinkDeathEffect extends BaseSkillEffect{
	
	public HurtLinkDeathEffect() {
	...
	public void doEffect(Frame frame, Unit unit, List<Unit> unitList, Skill skill, SkillFunction skillFunction) {
		...
		HurtLinkDeathBuffBear bear = new HurtLinkDeathBuffBear(unit.getId(),
